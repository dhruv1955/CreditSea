...
exports.getCollectionPaymentHistory = exports.recordPayment = exports.getCollectionQueue = exports.disburseLoan = exports.getDisbursementQueue = exports.rejectLoan = exports.approveLoan = exports.getSanctionQueue = exports.getSalesLeads = void 0;
...
const getCollectionPaymentHistory = async (req, res) => {
    try {
        const { loanId } = req.params;
        const loan = await Loan_1.Loan.findById(loanId);
        if (!loan) {
...
exports.getCollectionPaymentHistory = getCollectionPaymentHistory;
