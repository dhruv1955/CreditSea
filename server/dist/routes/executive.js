...
router.get("/collection/:loanId/payments", authenticate_1.authenticate, (0, authorize_1.authorize)(["collection", "admin"]), executiveController_1.getCollectionPaymentHistory);
